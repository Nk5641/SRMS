...
<html lang="en">
    <head>
        ...
        <style>
        .backgroundimage {
  background: url("images/play2.jpg") no-repeat center center fixed;
            ...
            <div class="content-wrapper">
                        <section class="section" id="exampl">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                <h2 class="title" align="center" style="color:white">Result Management System</h2>
...
<td colspan="3" align="center"><button type="button" class="btn btn-primary btn-lg btn-block"OnClick="CallPrint(this.value)" >Print</button></td>
                                                             </tr>
